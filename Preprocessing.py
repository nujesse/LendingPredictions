...
#         self.df.drop(['modela', 'repair', 'npay', 'pct', 'dti', 'jointincome', 'income', 'depend', 'netincome'], axis = 1, inplace = True)
...
#         self.drop_stock()
        ...
        print(f'\n-----\n\n{round(100*(len_before_processing - len_after_processing)/len_before_processing,1)}% of the values ({(len_before_processing - len_after_processing)} values) were wholesale and cash deals (deleted).')
        self.set_targets()
